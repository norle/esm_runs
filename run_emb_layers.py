...
def main():
    # --- Configuration ---
    model_name = 'esmc_600m' # Local model name
    fasta_path = '/home/s233201/esm_runs/inputs_new/LYS20.fasta'
    
    # To get the output of the 12th transformer layer:
    # If hidden_states[0] are input embeddings, then hidden_states[12] is what we want.
    layer_to_extract_0_indexed = 12 

    output_dir = Path(f'/home/s233201/esm_runs/embeddings_new_local_layer{layer_to_extract_0_indexed}')
